...
6. Keep responses sharp, encouraging, and within 2-3 sentences.`,
  ...
  'authors-breeze': {
    ...
    geminiApiKey: decodeKey('QUl6YVN5RFVCeWE3WUNXa0lxQUVTVDdncXFCSjR6RGlDM01vVHFr', 'GEMINI_KEY_AUTHORS_BREEZE'),
    phone: '+1 (833) 330-0306',
...
5. Keep answers encouraging, concise (2-3 sentences max), and focused on helping them become a published author.`,
  ...
  'pro-book-publishing': {
    ...
    geminiApiKey: decodeKey('QUl6YVN5Q1c3YmJ0UGhZWWFES1Q4SWtHUXpJdWlnZU5KYl9ldmNF', 'GEMINI_KEY_PRO_BOOK'),
    phone: '+1 (833) 330-0306',
...
5. Maintain a professional, welcoming tone in 2-3 sentences maximum.`,
  ...
  'amz-writers-hub': {
    ...
    geminiApiKey: decodeKey('QUl6YVN5QWlsS01SQWNCQjlISkZzVS1QaGRVUHhHa01XZjJYUE1R', 'GEMINI_KEY_AMZ_WRITERS'),
...
export const DEFAULT_WEBSITE_CONFIG: WebsiteConfig = {
  ...
  geminiApiKey: process.env.GEMINI_API_KEY || decodeKey('QVEuQWI4Uk42SmE2ekQ0YWticzlrdDhYRWpDSnJ4Y0JyekU3ekxVQkljVUdVWThYSDNWRWc=', 'GEMINI_API_KEY'),
  phone: '+1 (833) 330-0306',
